           ...
           <div className = 'container contactsec' id = 'contactid'>
               <div className = 'row'>
                   <div className = 'col-sm-6 col-xs-12'>
                       ...
                       <p className = 'mobileno'><span><i class="fa fa-phone"></i></span>&nbsp;&nbsp;+91 9515388779</p>
                       <p className = 'mailid'><span><i class="fa fa-envelope"></i></span>&nbsp;&nbsp;subbumahadasa@gmail.com</p>
                       <p  className = 'mailid'><a target = '_blank' href = 'https://www.linkedin.com/in/sai-subrahmanyam-229765163/'><i id = 'icon1' class="fab fa-linkedin"></i></a> <span><a id = 'icon2' target = '_blank' href = 'https://github.com/SubbuMahadasa'><i class="fab fa-github"></i></a></span></p>
